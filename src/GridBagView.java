 ...
 * @author cdepner
 */
public class GridBagView implements CalculatorView {
    ...
    public GridBagView() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GridBagView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
